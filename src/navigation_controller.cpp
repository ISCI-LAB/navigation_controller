...
const double NavigationController::MaxRobotLinearVelocity = 0.2;		// m/s
const double NavigationController::MaxRobotAngularVelocity = 45 * D2R;	// radian/s
